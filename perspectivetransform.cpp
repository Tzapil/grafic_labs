...
void PerspectiveTransform::translate(double dx, double dy)
{
...
void PerspectiveTransform::scale(double sx, double sy)
{
    m_11 *= sx; m_21 *= sx; m_31 *= sx;
    m_12 *= sy; m_22 *= sy; m_32 *= sy;
}

void PerspectiveTransform::rotate(double angle)
{
...
void PerspectiveTransform::shear(double shx, double shy)
{
